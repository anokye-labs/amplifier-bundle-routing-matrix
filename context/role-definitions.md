...
- **Model tier:** Mid (Sonnet, gpt-5.2, Gemini Pro)
...
- **Model tier:** Mid, code-specialized (Sonnet, gpt-5.3-codex, Gemini Pro)
...
- **Model tier:** Heavy (Opus, gpt-5.2, Gemini Pro) with high reasoning effort
...
- **Model tier:** Heavy (Opus, gpt-5.2, Gemini Pro) with default reasoning
...
- **Model tier:** Heavy (Opus, gpt-5.2-pro, Gemini Pro) with high reasoning effort
...
- **Model tier:** Mid, multimodal (Gemini Flash, Sonnet, gpt-5.3-codex)
